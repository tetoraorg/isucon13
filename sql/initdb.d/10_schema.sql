...
CREATE TABLE `livestreams` (
  ...
  INDEX livestreams_user_id (`user_id`)
) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
...
CREATE TABLE `reservation_slots` (
  ...
  `start_at` BIGINT NOT NULL,
  `end_at` BIGINT NOT NULL,
  INDEX reservation_slots_start_end (`start_at`, `end_at`)
) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
...
CREATE TABLE `livestream_tags` (
  ...
  INDEX livestream_tags_livestream_id (`tag_id`, `livestream_id` DESC)
) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
...
CREATE INDEX ng_words_livestream_user_id ON ng_words(`livestream_id`, `user_id`);
